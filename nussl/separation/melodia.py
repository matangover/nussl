...
class Melodia(mask_separation_base.MaskSeparationBase):
    ...
    def run(self):
        ...
        self._make_foreground_signal(foreground_stft)

        # make a mask and return
        foreground_mask = masks.SoftMask(foreground_mask)
        self.result_masks = [foreground_mask.inverse_mask(), foreground_mask]

        return self.result_masks
    
    def _make_foreground_signal(self, foreground_stft):
        self.foreground = self.audio_signal.make_copy_with_stft_data(foreground_stft, verbose=False)
    ...
    def make_audio_signals(self):
        ...
        .. code-block:: python
            ...
            background, foreground = melodia.make_audio_signals()
